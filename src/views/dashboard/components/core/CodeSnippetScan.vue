<template>
  ...
  <!-- <transition name="fade-in" @enter="enter" @leave="leave" appear>
    <div>
  ...
  <code-snippet-result :result="result" :is-closed="isClosed" @update-close-state="this.isClosed = !this.isClosed"></code-snippet-result>
</template>

<script>
import gql from "graphql-tag";
import jsonPath from "jsonpath";
import CodeSnippetResult from './CodeSnippetResult.vue'
